...
import com.techno_3_team.task_manager.databinding.SubtaskViewBinding
import com.techno_3_team.task_manager.support.dp
import java.lang.Integer.max

class SubTaskView @JvmOverloads constructor(
    context: Context,
    ...
    private val binding: SubtaskViewBinding
    ...
    init {
        ...
        View.inflate(context, R.layout.subtask_view, this)
        binding = SubtaskViewBinding.bind(this)
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        val dateBottom = SECONDARY_SPACE
        date.layout(
            textViewLeft,
