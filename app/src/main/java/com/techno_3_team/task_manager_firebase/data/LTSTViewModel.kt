...
class LTSTViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun getLists(): List<com.techno_3_team.task_manager_firebase.data.entities.List> {
        val lists = arrayListOf<com.techno_3_team.task_manager_firebase.data.entities.List>()
    ...
    fun updateListName(list: com.techno_3_team.task_manager_firebase.data.entities.List) {
        viewModelScope.launch(Dispatchers.IO) {
